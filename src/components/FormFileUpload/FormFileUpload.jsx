...
import { fileFormUploaded, fileFormClear } from '../../redux/file/action';

const FormFileUpload = ({fileFormClear, fileFormUploaded}) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(FormFileUpload);