                ...
                <Modal.Body>
                    {data.jobPositionName ? <Form.Group> 
                        <Form.Row>
                            ...
                            <Col sm="6">
                                <Form.Control readOnly  type="text" value={data.jobPositionName} name='jobPositionName' component={Input}/> 
                            </Col>
                        </Form.Row>
                    </Form.Group> : null}
                    ...
                    {data.salary ? <Form.Group> 
                        <Form.Row>
                            ...
                            <Col sm="6">
                                <Form.Control readOnly type="text"  name='salary' value={data.salary} component={Input}/> 
                            </Col>
                        </Form.Row>
                    </Form.Group> : null}
                    ...
                    {data.costMinute ? <Form.Group> 
                        <Form.Row>
                            ...
                            <Col sm="6">
                                <Form.Control readOnly type="text"  value={data.costMinute} name='costMinute' component={Input}/> 
                            </Col>
                        </Form.Row>
                    </Form.Group> : null}
                    ...
                    {data.coefficient ? <Form.Group> 
                        <Form.Row>
                            ...
                            <Col sm="6">
                                <Form.Control readOnly type="text"  value={data.coefficient} name='coefficient' component={Input}/> 
                            </Col>
                        </Form.Row>
                    </Form.Group> : null}
                    ...
                    {data.costNormal ? <Form.Group> 
                        <Form.Row>
                            ...
                            <Col sm="6">
                                <Form.Control readOnly type="text"  value={data.costNormal} name='costNormal' component={Input}/> 
                            </Col>
                        </Form.Row>
                    </Form.Group> : null}
                    ...
                    {data.coefficientJobPosition ? <Form.Group> 
                        <Form.Row>
                            ...
                            <Col sm="6">
                                <Form.Control readOnly type="text"  value={data.coefficientJobPosition} name='coefficientJobPosition' component={Input}/> 
                            </Col>
                        </Form.Row>
                    </Form.Group> : null}
                    ...
                    {data.dateStart ? <Form.Group> 
                        <Form.Row>
                            ...
                            <Col sm="6">
                                ...
                                name='dateStart' component={Input}/> 
                            </Col>
                        </Form.Row>
                    </Form.Group> : null}
                    ...
                    {data.comment ? <Form.Group> 
                        <Form.Row>
                            ...
                            <Col sm="6">
                                <Form.Control readOnly type="text"  value={data.comment} name='comment' component={Input}/> 
                            </Col>
                        </Form.Row>
                    </Form.Group> : null}
                </Modal.Body>
